...
public class VerifiedText extends PlainText implements VerificationInterface{
    ...
    public VerifiedText(String text, SignedTextInterface signedText, CertificateIssuer issuers, X509CRL crl){
    	super(text);
    	this.base64signedValue = signedText.toBase64();
    	if (crl!=null)
    	this.crl = crl;
...
/* (non-Javadoc)
 * @see tools.pki.gbay.crypto.texts.VerificationInterface#getBase64signedValue()
 */
@Override
...
/* (non-Javadoc)
 * @see tools.pki.gbay.crypto.texts.VerificationInterface#setBase64signedValue(tools.pki.gbay.crypto.texts.Base64)
 */
@Override
...
/* (non-Javadoc)
 * @see tools.pki.gbay.crypto.texts.VerificationInterface#setVerified(boolean)
 */
@Override
...
/* (non-Javadoc)
 * @see tools.pki.gbay.crypto.texts.VerificationInterface#isVerifiedAndValidated()
 */
@Override
...
/* (non-Javadoc)
 * @see tools.pki.gbay.crypto.texts.VerificationInterface#setValidated(boolean)
 */
@Override
